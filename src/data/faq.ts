export const FAQ = [
    ...
    },
    {
        ...
        answer: "In the event of an accident, our trained staff will provide immediate first aid and assess the situation. We maintain thorough accident records for transparency and safety evaluation.<br />Children who regularly play outdoors are less prone to injuries, they have a natural ability to assess risks and have a better understanding of their physical limits compared to those with less outdoor exposure.<br /><br />For minor bumps, scrapes, and scratches, our educators, all of whom are trained in paediatric first aid, will care for your child. An accident report will be filled out and shared with parents. In the rare instance of a head bump, we will promptly inform parents via telephone.<br /><br />In the highly unlikely event of a more serious accident, school staff will be called to site and our trained first aider educator will attend to your child while the second educator contacts medical professionals to come to the site. Parents will be immediately informed of the situation, and if necessary, we will stay with your child until you can arrive."
    },
    {
